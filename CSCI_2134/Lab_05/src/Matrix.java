...
public class Matrix {
    ...
    public Matrix add(Matrix b, Matrix res) throws IllegalArgumentException,
        ...
        if ((res == null) || (b == null) ||
            ...
            throw new IllegalArgumentException("Matrices are not allocated or have different sizes: "+ "Matrix B = "+ b+" Matrix res = "+ res);
        }
    ...
    public Matrix multiplyWithScalar(double s, Matrix res) throws IllegalArgumentException{
        if(res==null) throw new IllegalArgumentException("Matrice res is not allocated.");
        // if res is not allocated return null
            ...
            if ((res.getHeight() != height) || (res.getWidth() != width)) {
                throw new IllegalArgumentException("Matrice res has different size.");
            }
    ...
    public Matrix multiplyWithMatrix (Matrix b, Matrix res) throws IllegalArgumentException{
        ...
        if ((res == null) || (b == null)) {
            throw new IllegalArgumentException("Matrices are not allocated: "+ "Matrix b = "+b+" Matrix res = "+res);
        }
